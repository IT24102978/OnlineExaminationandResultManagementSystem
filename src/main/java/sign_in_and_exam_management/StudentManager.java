...
public class StudentManager {
    ...
    // Constructor
    public StudentManager(ServletContext context) {
    ...
    // Load students from students2.txt
    private void loadFromFile() {
        String realPath = servletContext.getRealPath("/WEB-INF/users.txt");
    ...
    // Save students to students2.txt
