...
<div class="sidebar">
    <div>
        ...
        <nav class="nav-links">
            <a href="register-student.jsp" class="nav-link">
                <i class="fas fa-user-plus"></i>
                <span>Register Admin</span>
            </a>
            <a href="edit-student.jsp" class="nav-link">
                <i class="fas fa-file-alt"></i>
                <span>Project Documentation</span>
            </a>
            <a href="add-submission.jsp" class="nav-link">
                <i class="fas fa-link"></i>
                <span>Deployed Project Link</span>
            </a>
            <a href="edit-submission.jsp" class="nav-link">
...
<div class="main">
    <div class="top-bar">
        ...
        <div class="user-actions">
            <a href="#"><i class="fas fa-chalkboard-teacher"></i> Switch to Teacher View</a>
    ...
    <div class="action-buttons">
        <button id="openModalBtn" class="btn btn-green">
            <i class="fas fa-user-plus"></i> NEW STUDENT
        </button>
        <a href="edit-student.jsp" class="btn btn-red">
            <i class="fas fa-user-edit"></i> EDIT STUDENT
        </a>
        <a href="add-submission.jsp" class="btn btn-green">
            <i class="fas fa-plus-circle"></i> ADD SUBMISSION
        </a>
        <a href="edit-submission.jsp" class="btn btn-brown">
    ...
    <div class="modal-box">
        ...
        <form>
            ...
            <div class="modal-note">
                <i class="fas fa-info-circle"></i> DEFAULT PASSWORD WILL BE SET AS THE NATIONAL ID CARD NUMBER
            </div>
            ...
            <div class="modal-buttons">
                ...
                <button type="button" id="closeModalBtn" class="btn btn-red">
